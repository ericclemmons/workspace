...
- **Agent edit guard:** blocks edits outside `worktrees/*`, blocks meta-infrastructure (`.githooks/`, `AGENTS.md`, `.claude/`, `opencode.json`, `mise.toml`, `hk.pkl`, `mise-tasks/*`), allows valid paths.
